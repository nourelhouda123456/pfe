...
export class InfoOpComponent implements OnInit {
  ...
  selectedOption1: string = 'MatriculeFiscal'; // Default to 'MatriculeFiscal'
  matriculeFiscalValue: string = '';
  ...
  onOptionChange(event: any) {
      ...
      // Reset the values when the option changes
      this.matriculeFiscalValue = '';
      this.identifiantValue = '';
...
// Method to check if "Autre" is selected
onNatureRelationChange(event: any) {
