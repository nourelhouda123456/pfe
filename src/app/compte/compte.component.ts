...
export class CompteComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private EntrepriseService: ServiceService ) {}
    ...
    this.form = this.formBuilder.group(
      {
        ...
        CodeActe: [
          '0', // Default value set to "0" for the first deposit
          [
            Validators.required,
            Validators.pattern('^[014]$') // Regular expression to match 0, 1, or 4
          ]
        ],
  ...
  onSubmit(): void {
    ...
    const newEntreprise: Entreprise = {
      ...
      codeActe: this.form.get('CodeActe')?.value,
      ...
      declarations: null // Assuming this will be handled separately
    };
